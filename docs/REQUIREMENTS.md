...
**Related documents**: [DATAMODEL.md](DATAMODEL.md) (entity model and schema) · [SOURCES.md](SOURCES.md) (data source inventory) · [PIPELINE.md](PIPELINE.md) (extraction pipeline)
